...
- **V100 (sm70) users**: recent official vLLM releases no longer support sm70 — use [1Cat-vLLM](https://github.com/1CatAI/1Cat-vLLM) instead (a vLLM fork with SM70 support), default image `docker.io/sssssks/1cat-vllm:latest`
